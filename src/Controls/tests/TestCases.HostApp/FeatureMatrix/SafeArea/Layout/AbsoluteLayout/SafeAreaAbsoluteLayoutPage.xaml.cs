...
public partial class SafeAreaAbsoluteLayoutPage : ContentPage
{
    private SafeAreaViewModel _viewModel;

    public SafeAreaAbsoluteLayoutPage(SafeAreaViewModel viewModel)
    {
        InitializeComponent();
        _viewModel = viewModel;
        BindingContext = _viewModel;
#if ANDROID
        // Set SoftInput.AdjustNothing so the AbsoluteLayout handles insets itself (iOS-like behavior)
    ...
    private void OnPageAppearing(object sender, EventArgs e)
    {
        ...
        {
            ViewCompat.SetOnApplyWindowInsetsListener(decorView, new SafeAreaAbsoluteLayoutInsetsListener(this));
        }
#endif
    }
...
/// </summary>
class SafeAreaAbsoluteLayoutInsetsListener : Java.Lang.Object, IOnApplyWindowInsetsListener
{
    private readonly SafeAreaAbsoluteLayoutPage _page;

    public SafeAreaAbsoluteLayoutInsetsListener(SafeAreaAbsoluteLayoutPage page)
    {
        _page = page;
    }
