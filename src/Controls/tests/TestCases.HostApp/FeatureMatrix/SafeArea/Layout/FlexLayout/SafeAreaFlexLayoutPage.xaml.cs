...
public partial class SafeAreaFlexLayoutPage : ContentPage
{
	private SafeAreaViewModel _viewModel;

	public SafeAreaFlexLayoutPage(SafeAreaViewModel viewModel)
	{
		InitializeComponent();
		_viewModel = viewModel;
		BindingContext = _viewModel;
#if ANDROID
		// Set SoftInput.AdjustNothing so the FlexLayout handles insets itself (iOS-like behavior)
	...
	private void OnPageAppearing(object sender, EventArgs e)
	{
		...
		{
			ViewCompat.SetOnApplyWindowInsetsListener(decorView, new SafeAreaFlexLayoutInsetsListener(this));
		}
#endif
	}
...
/// </summary>
class SafeAreaFlexLayoutInsetsListener : Java.Lang.Object, IOnApplyWindowInsetsListener
{
	private readonly SafeAreaFlexLayoutPage _page;

	public SafeAreaFlexLayoutInsetsListener(SafeAreaFlexLayoutPage page)
	{
		_page = page;
	}
