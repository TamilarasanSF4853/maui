...
public partial class SafeAreaStackLayoutVerticalPage : ContentPage
{
	private SafeAreaViewModel _viewModel;

	public SafeAreaStackLayoutVerticalPage(SafeAreaViewModel viewModel)
	{
		InitializeComponent();
	...
	private void OnPageAppearing(object sender, EventArgs e)
	{
		...
		{
			ViewCompat.SetOnApplyWindowInsetsListener(decorView, new SafeAreaStackLayoutVerticalInsetsListener(this));
		}
#endif
	}
...
/// </summary>
class SafeAreaStackLayoutVerticalInsetsListener : Java.Lang.Object, IOnApplyWindowInsetsListener
{
	private readonly SafeAreaStackLayoutVerticalPage _page;

	public SafeAreaStackLayoutVerticalInsetsListener(SafeAreaStackLayoutVerticalPage page)
	{
		_page = page;
	}
