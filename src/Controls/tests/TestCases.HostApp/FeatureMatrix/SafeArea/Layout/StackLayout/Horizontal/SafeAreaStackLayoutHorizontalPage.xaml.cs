...
public partial class SafeAreaStackLayoutHorizontalPage : ContentPage
{
	private SafeAreaViewModel _viewModel;

	public SafeAreaStackLayoutHorizontalPage(SafeAreaViewModel viewModel)
	{
		InitializeComponent();
		_viewModel = viewModel;
		BindingContext = _viewModel;
#if ANDROID
		// Set SoftInput.AdjustNothing so the StackLayout handles insets itself (iOS-like behavior)
	...
	private void OnPageAppearing(object sender, EventArgs e)
	{
		...
		{
			ViewCompat.SetOnApplyWindowInsetsListener(decorView, new SafeAreaStackLayoutHorizontalInsetsListener(this));
		}
#endif
	}
...
/// </summary>
class SafeAreaStackLayoutHorizontalInsetsListener : Java.Lang.Object, IOnApplyWindowInsetsListener
{
	private readonly SafeAreaStackLayoutHorizontalPage _page;

	public SafeAreaStackLayoutHorizontalInsetsListener(SafeAreaStackLayoutHorizontalPage page)
	{
		_page = page;
	}
