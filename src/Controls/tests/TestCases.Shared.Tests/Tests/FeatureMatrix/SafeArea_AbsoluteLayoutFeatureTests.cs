...
namespace Microsoft.Maui.TestCases.Tests
{
	...
	public class SafeArea_AbsoluteLayoutFeatureTests : _GalleryUITest
	{
		...
		public SafeArea_AbsoluteLayoutFeatureTests(TestDevice device)
			: base(device)
		{
		}
		...
		/// <summary>
		/// Navigates to SafeAreaAbsoluteLayoutPage from the feature matrix main page.
		/// If already on SafeAreaAbsoluteLayoutPage (button not visible), skips navigation.
		/// </summary>
		public void ClickAbsoluteLayoutSafeAreaButton()
		{
			var isButtonPresent = App.FindElement("AbsoluteLayoutSafeAreaButton");
			if (isButtonPresent != null)
			{
				App.WaitForElement("AbsoluteLayoutSafeAreaButton");
				App.Tap("AbsoluteLayoutSafeAreaButton");
			}
		}
		...
		[Test, Order(1)]
		[Description("AbsoluteLayout content extends edge-to-edge behind system bars/notch")]
		public void ValidateSafeAreaEdges_None_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			...
			// Portrait: top label Y should be ≈ 0 (edge-to-edge, AbsoluteLayout applies no safe area padding)
		...
		[Test, Order(2)]
		[Description("AbsoluteLayout content inset from all system UI (status bar, nav bar, notch, home indicator)")]
		public void ValidateSafeAreaEdges_All_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		[Test, Order(3)]
		[Description("AbsoluteLayout content avoids system bars/notch but can extend under keyboard area")]
		public void ValidateSafeAreaEdges_Container_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		[Test, Order(4)]
		[Description("AbsoluteLayout SoftInput respects safe area on top/sides but bottom is edge-to-edge without keyboard")]
		public void ValidateSafeAreaEdges_SoftInput_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		[Test, Order(5)]
		[Description("Default on AbsoluteLayout behaves as Container — content inset from system UI (status bar, notch, home indicator)")]
		public void ValidateSafeAreaEdges_Default_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			...
			// Portrait: top label Y should be ≈ insets.Top (Default on AbsoluteLayout = Container)
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default: top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on AbsoluteLayout = Container)");

			// Portrait: bottom label bottom edge should be ≈ screenHeight - insets.Bottom (Default on AbsoluteLayout = Container)
			var bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default: bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on AbsoluteLayout = Container)");
		}
		...
		public void ValidatePerEdge_TopContainerOnly_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			...
			// Portrait: Container — AbsoluteLayout top padding absorbs safe area
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
		...
		public void ValidatePerEdge_BottomSoftInput_TopContainer_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			...
			// Top: Container — AbsoluteLayout top padding absorbs safe area
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Top (Container): label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top})");
		...
		public void ValidatePerEdge_TopBottomAll_SidesNone_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidatePerEdge_AllDifferent_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidateSafeArea_NoneThenAllKeyboardContainerDismissAll_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_All_BottomMovesUp_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_BottomMovesUp_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_BottomStays_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_BottomStays_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToAll_WhileKeyboardOpen_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToSoftInput_WhileKeyboardOpen_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchAllToNone_WhileKeyboardOpen_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchContainerToSoftInput_WhileKeyboardOpen_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_CycleThroughAllModes_WhileKeyboardOpen_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Switch to Default (keyboard still open) ── (Default on AbsoluteLayout = Container — inset from system UI, ignores keyboard)
			App.Tap("SafeAreaDefaultButton");
			Assert.That(App.FindElement("SafeAreaEdgesValueLabel").GetText(), Is.EqualTo("Default"));

			topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default (keyboard open) - top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on AbsoluteLayout = Container)");

#if IOS
			bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default (keyboard open) - bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on AbsoluteLayout = Container, ignores keyboard)");
#else
			App.WaitForNoElement("BottomEdgeIndicator"); // On Android, Appium does not find the bottom label when the keyboard is open
#endif
		...
		// ──────────────────────────────────────────────
		// Interaction with AbsoluteLayout Properties
		// ──────────────────────────────────────────────

		[Test, Order(20)]
		[Description("Safe area insets and AbsoluteLayout padding are additive")]
		public void ValidateSafeArea_WithPadding_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		[Test, Order(21)]
		[Description("AbsoluteLayout background extends edge-to-edge behind system UI")]
		public void ValidateSafeArea_None_WithBackground_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidateOrientation_None_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidateOrientation_All_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidateOrientation_Container_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		public void ValidateOrientation_SoftInput_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
		...
		[Test, Order(26)]
		[Description("Default: landscape left/right/bottom all inset from system UI (Default on AbsoluteLayout = Container)")]
		public void ValidateOrientation_Default_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			...
			// Left: inset from system UI (Default on AbsoluteLayout = Container)
			var leftRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Default: left X ({leftRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on AbsoluteLayout = Container)");
			...
			var expectedRight = GetLandscapeRightInset(insetsLandscape.Right, insetsLandscape.CutoutR);
			Assert.That(Math.Abs(rightEdge), Is.EqualTo(screenWidth - expectedRight).Within(PixelTolerance),
				$"Default: right edge ({rightEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRight}) (Default on AbsoluteLayout = Container)");

			// Bottom: inset from system UI
			var bottomRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Default: bottom edge ({bottomRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on AbsoluteLayout = Container)");
		...
		public void ValidateKeyboard_All_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		[Test, Order(31)]
		[Description("Landscape Default: all edges inset from system UI; keyboard does not move bottom (Default on AbsoluteLayout = Container)")]
		public void ValidateKeyboard_Default_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Before keyboard (Default on AbsoluteLayout = Container — inset from system UI) ──
			var leftBeforeRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftBeforeRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Before keyboard - left X ({leftBeforeRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on AbsoluteLayout = Container)");
			...
			Assert.That(Math.Abs(rightBeforeEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"Before keyboard - right edge ({rightBeforeEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on AbsoluteLayout = Container)");

			var bottomBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomBeforeRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom edge ({bottomBeforeRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on AbsoluteLayout = Container)");
			...
			Assert.That(Math.Abs(leftDuringRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"During keyboard - left X ({leftDuringRect.X}) should remain at insetsLandscape.Left ({insetsLandscape.Left}) (Default on AbsoluteLayout = Container)");

			var rightDuringRect = App.WaitForElement("RightEdgeIndicator").GetRect();
			var rightDuringEdge = rightDuringRect.X + rightDuringRect.Width;
			Assert.That(Math.Abs(rightDuringEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"During keyboard - right edge ({rightDuringEdge}) should remain at screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on AbsoluteLayout = Container)");
		...
		[Test, Order(32)]
		[Description("With Default (Container on AbsoluteLayout), top/bottom are inset from system UI and do NOT move when keyboard is shown")]
		public void ValidateKeyboard_Default_BottomStays_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			var topLabelBeforeRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelBeforeRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Before keyboard - top label Y ({topLabelBeforeRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on AbsoluteLayout = Container)");

			var bottomLabelBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelBeforeRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom label Bottom ({bottomLabelBeforeRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on AbsoluteLayout = Container)");
...
#if IOS
			// Bottom should NOT move (Default = Container on AbsoluteLayout — ignores keyboard)
			var bottomLabelDuringRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			...
			Assert.That(Math.Abs(topLabelDuringRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"During keyboard - top label Y ({topLabelDuringRect.Y}) should remain at insets.Top ({insets.Top}) (Default on AbsoluteLayout = Container)");
		...
		public void ValidatePerEdgeKeyboard_BottomNone_BottomStays_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomContainer_BottomStays_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomSoftInput_BottomMovesUp_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomAll_BottomMovesUp_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdge_LeftContainerRightNone_Landscape_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateOrientation_Roundtrip_PositionsRestore_AbsoluteLayout()
		{
			ClickAbsoluteLayoutSafeAreaButton();
			App.DismissKeyboard();
