...
namespace Microsoft.Maui.TestCases.Tests
{
	...
	public class SafeArea_StackLayoutHorizontalFeatureTests : _GalleryUITest
	{
		...
		public SafeArea_StackLayoutHorizontalFeatureTests(TestDevice device)
			: base(device)
		{
		}
		...
		/// <summary>
		/// Navigates to SafeAreaStackLayoutHorizontalPage from the feature matrix main page.
		/// If already on SafeAreaStackLayoutHorizontalPage (button not visible), skips navigation.
		/// </summary>
		public void ClickStackLayoutHorizontalSafeAreaButton()
		{
			var isButtonPresent = App.FindElement("StackLayoutHorizontalSafeAreaButton");
			if (isButtonPresent != null)
			{
				App.WaitForElement("StackLayoutHorizontalSafeAreaButton");
				App.Tap("StackLayoutHorizontalSafeAreaButton");
			}
		}
		...
		public void ValidateSafeAreaEdges_None_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateSafeAreaEdges_All_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateSafeAreaEdges_Container_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateSafeAreaEdges_SoftInput_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		[Test, Order(5)]
		[Description("Default on StackLayout behaves as Container — content inset from system UI (status bar, notch, home indicator)")]
		public void ValidateSafeAreaEdges_Default_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			...
			// Portrait: top label Y should be ≈ insets.Top (Default on StackLayout = Container)
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default: top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on StackLayout = Container)");

			// Portrait: bottom label bottom edge should be ≈ screenHeight - insets.Bottom (Default on StackLayout = Container)
			var bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default: bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on StackLayout = Container)");
		}
		...
		public void ValidatePerEdge_TopContainerOnly_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidatePerEdge_BottomSoftInput_TopContainer_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidatePerEdge_TopBottomAll_SidesNone_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidatePerEdge_AllDifferent_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateSafeArea_NoneThenAllKeyboardContainerDismissAll_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_All_BottomMovesUp_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_BottomMovesUp_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_BottomStays_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_BottomStays_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToAll_WhileKeyboardOpen_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToSoftInput_WhileKeyboardOpen_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchAllToNone_WhileKeyboardOpen_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchContainerToSoftInput_WhileKeyboardOpen_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_CycleThroughAllModes_WhileKeyboardOpen_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Switch to Default (keyboard still open) ── (Default on StackLayout = Container — inset from system UI, ignores keyboard)
			App.Tap("SafeAreaDefaultButton");
			Assert.That(App.FindElement("SafeAreaEdgesValueLabel").GetText(), Is.EqualTo("Default"));

			topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default (keyboard open) - top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on StackLayout = Container)");

#if IOS
			bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default (keyboard open) - bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on StackLayout = Container, ignores keyboard)");
#else
			App.WaitForNoElement("BottomEdgeIndicator"); // On Android, Appium does not find the bottom label when the keyboard is open
#endif
		...
		public void ValidateSafeArea_WithPadding_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateSafeArea_None_WithBackground_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateOrientation_None_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateOrientation_All_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateOrientation_Container_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		public void ValidateOrientation_SoftInput_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
		...
		[Test, Order(26)]
		[Description("Default: landscape left/right/bottom all inset from system UI (Default on StackLayout = Container)")]
		public void ValidateOrientation_Default_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			...
			// Left: inset from system UI (Default on StackLayout = Container)
			var leftRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Default: left X ({leftRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on StackLayout = Container)");
			...
			var expectedRight = GetLandscapeRightInset(insetsLandscape.Right, insetsLandscape.CutoutR);
			Assert.That(Math.Abs(rightEdge), Is.EqualTo(screenWidth - expectedRight).Within(PixelTolerance),
				$"Default: right edge ({rightEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRight}) (Default on StackLayout = Container)");

			// Bottom: inset from system UI
			var bottomRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Default: bottom edge ({bottomRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on StackLayout = Container)");
		...
		public void ValidateKeyboard_All_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		[Test, Order(31)]
		[Description("Landscape Default: all edges inset from system UI; keyboard does not move bottom (Default on StackLayout = Container)")]
		public void ValidateKeyboard_Default_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Before keyboard (Default on StackLayout = Container — inset from system UI) ──
			var leftBeforeRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftBeforeRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Before keyboard - left X ({leftBeforeRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on StackLayout = Container)");
			...
			Assert.That(Math.Abs(rightBeforeEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"Before keyboard - right edge ({rightBeforeEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on StackLayout = Container)");

			var bottomBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomBeforeRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom edge ({bottomBeforeRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on StackLayout = Container)");
			...
			Assert.That(Math.Abs(leftDuringRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"During keyboard - left X ({leftDuringRect.X}) should remain at insetsLandscape.Left ({insetsLandscape.Left}) (Default on StackLayout = Container)");

			var rightDuringRect = App.WaitForElement("RightEdgeIndicator").GetRect();
			var rightDuringEdge = rightDuringRect.X + rightDuringRect.Width;
			Assert.That(Math.Abs(rightDuringEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"During keyboard - right edge ({rightDuringEdge}) should remain at screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on StackLayout = Container)");
		...
		public void ValidateKeyboard_Default_BottomStays_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
			...
			var topLabelBeforeRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelBeforeRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Before keyboard - top label Y ({topLabelBeforeRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on StackLayout = Container)");

			var bottomLabelBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelBeforeRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom label Bottom ({bottomLabelBeforeRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on StackLayout = Container)");
			...
			Assert.That(Math.Abs(topLabelDuringRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"During keyboard - top label Y ({topLabelDuringRect.Y}) should remain at insets.Top ({insets.Top}) (Default on StackLayout = Container)");
		...
		public void ValidatePerEdgeKeyboard_BottomNone_BottomStays_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomContainer_BottomStays_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomSoftInput_BottomMovesUp_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomAll_BottomMovesUp_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdge_LeftContainerRightNone_Landscape_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateOrientation_Roundtrip_PositionsRestore_HorizontalStackLayout()
		{
			ClickStackLayoutHorizontalSafeAreaButton();
			App.DismissKeyboard();
