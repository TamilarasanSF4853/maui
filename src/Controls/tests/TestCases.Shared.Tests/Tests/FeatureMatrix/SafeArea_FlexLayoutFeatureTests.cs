...
namespace Microsoft.Maui.TestCases.Tests
{
	...
	public class SafeArea_FlexLayoutFeatureTests : _GalleryUITest
	{
		...
		public SafeArea_FlexLayoutFeatureTests(TestDevice device)
			: base(device)
		{
		}
		...
		/// <summary>
		/// Navigates to SafeAreaFlexLayoutPage from the feature matrix main page.
		/// If already on SafeAreaFlexLayoutPage (button not visible), skips navigation.
		/// </summary>
		public void ClickFlexLayoutSafeAreaButton()
		{
			var isButtonPresent = App.FindElement("FlexLayoutSafeAreaButton");
			if (isButtonPresent != null)
			{
				App.WaitForElement("FlexLayoutSafeAreaButton");
				App.Tap("FlexLayoutSafeAreaButton");
			}
		}
		...
		[Test, Order(1)]
		[Description("FlexLayout content extends edge-to-edge behind system bars/notch")]
		public void ValidateSafeAreaEdges_None_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			...
			// Portrait: top label Y should be ≈ 0 (edge-to-edge, FlexLayout applies no safe area padding)
		...
		[Test, Order(2)]
		[Description("FlexLayout content inset from all system UI (status bar, nav bar, notch, home indicator)")]
		public void ValidateSafeAreaEdges_All_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		[Test, Order(3)]
		[Description("FlexLayout content avoids system bars/notch but can extend under keyboard area")]
		public void ValidateSafeAreaEdges_Container_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		[Test, Order(4)]
		[Description("FlexLayout SoftInput respects safe area on top/sides but bottom is edge-to-edge without keyboard")]
		public void ValidateSafeAreaEdges_SoftInput_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		[Test, Order(5)]
		[Description("Default on FlexLayout behaves as Container — content inset from system UI (status bar, notch, home indicator)")]
		public void ValidateSafeAreaEdges_Default_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			...
			// Portrait: top label Y should be ≈ insets.Top (Default on FlexLayout = Container)
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default: top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on FlexLayout = Container)");

			// Portrait: bottom label bottom edge should be ≈ screenHeight - insets.Bottom (Default on FlexLayout = Container)
			var bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default: bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on FlexLayout = Container)");
		}
		...
		public void ValidatePerEdge_TopContainerOnly_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			...
			// Portrait: Container — FlexLayout top padding absorbs safe area
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
		...
		public void ValidatePerEdge_BottomSoftInput_TopContainer_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			...
			// Top: Container — FlexLayout top padding absorbs safe area
			var topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Top (Container): label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top})");
		...
		public void ValidatePerEdge_TopBottomAll_SidesNone_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidatePerEdge_AllDifferent_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidateSafeArea_NoneThenAllKeyboardContainerDismissAll_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_All_BottomMovesUp_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_BottomMovesUp_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_BottomStays_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_BottomStays_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToAll_WhileKeyboardOpen_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchNoneToSoftInput_WhileKeyboardOpen_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchAllToNone_WhileKeyboardOpen_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_SwitchContainerToSoftInput_WhileKeyboardOpen_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboardRuntime_CycleThroughAllModes_WhileKeyboardOpen_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Switch to Default (keyboard still open) ── (Default on FlexLayout = Container — inset from system UI, ignores keyboard)
			App.Tap("SafeAreaDefaultButton");
			Assert.That(App.FindElement("SafeAreaEdgesValueLabel").GetText(), Is.EqualTo("Default"));

			topLabelRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Default (keyboard open) - top label Y ({topLabelRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on FlexLayout = Container)");

#if IOS
			bottomLabelRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Default (keyboard open) - bottom label Bottom ({bottomLabelRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on FlexLayout = Container, ignores keyboard)");
#else
			App.WaitForNoElement("BottomEdgeIndicator"); // On Android, Appium does not find the bottom label when the keyboard is open
#endif
		...
		// ──────────────────────────────────────────────
		// Interaction with FlexLayout Properties
		// ──────────────────────────────────────────────

		[Test, Order(20)]
		[Description("Safe area insets and FlexLayout padding are additive")]
		public void ValidateSafeArea_WithPadding_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		[Test, Order(21)]
		[Description("FlexLayout background extends edge-to-edge behind system UI")]
		public void ValidateSafeArea_None_WithBackground_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidateOrientation_None_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidateOrientation_All_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidateOrientation_Container_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		public void ValidateOrientation_SoftInput_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
		...
		[Test, Order(26)]
		[Description("Default: landscape left/right/bottom all inset from system UI (Default on FlexLayout = Container)")]
		public void ValidateOrientation_Default_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			...
			// Left: inset from system UI (Default on FlexLayout = Container)
			var leftRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Default: left X ({leftRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on FlexLayout = Container)");
			...
			var expectedRight = GetLandscapeRightInset(insetsLandscape.Right, insetsLandscape.CutoutR);
			Assert.That(Math.Abs(rightEdge), Is.EqualTo(screenWidth - expectedRight).Within(PixelTolerance),
				$"Default: right edge ({rightEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRight}) (Default on FlexLayout = Container)");

			// Bottom: inset from system UI
			var bottomRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Default: bottom edge ({bottomRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on FlexLayout = Container)");
		...
		public void ValidateKeyboard_All_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_SoftInput_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_None_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateKeyboard_Container_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		[Test, Order(31)]
		[Description("Landscape Default: all edges inset from system UI; keyboard does not move bottom (Default on FlexLayout = Container)")]
		public void ValidateKeyboard_Default_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			// ── Before keyboard (Default on FlexLayout = Container — inset from system UI) ──
			var leftBeforeRect = App.WaitForElement("LeftEdgeIndicator").GetRect();
			Assert.That(Math.Abs(leftBeforeRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"Before keyboard - left X ({leftBeforeRect.X}) should be ≈ insetsLandscape.Left ({insetsLandscape.Left}) (Default on FlexLayout = Container)");
			...
			Assert.That(Math.Abs(rightBeforeEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"Before keyboard - right edge ({rightBeforeEdge}) should be ≈ screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on FlexLayout = Container)");

			var bottomBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomBeforeRect.Bottom), Is.EqualTo(screenHeight - insetsLandscape.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom edge ({bottomBeforeRect.Bottom}) should be ≈ screenHeight - insetsLandscape.Bottom ({screenHeight - insetsLandscape.Bottom}) (Default on FlexLayout = Container)");
			...
			Assert.That(Math.Abs(leftDuringRect.X), Is.EqualTo(insetsLandscape.Left).Within(PixelTolerance),
				$"During keyboard - left X ({leftDuringRect.X}) should remain at insetsLandscape.Left ({insetsLandscape.Left}) (Default on FlexLayout = Container)");

			var rightDuringRect = App.WaitForElement("RightEdgeIndicator").GetRect();
			var rightDuringEdge = rightDuringRect.X + rightDuringRect.Width;
			Assert.That(Math.Abs(rightDuringEdge), Is.EqualTo(screenWidth - expectedRightDefault).Within(PixelTolerance),
				$"During keyboard - right edge ({rightDuringEdge}) should remain at screenWidth - expectedRight ({screenWidth - expectedRightDefault}) (Default on FlexLayout = Container)");
		...
		[Test, Order(32)]
		[Description("With Default (Container on FlexLayout), top/bottom are inset from system UI and do NOT move when keyboard is shown")]
		public void ValidateKeyboard_Default_BottomStays_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
			...
			var topLabelBeforeRect = App.WaitForElement("TopEdgeIndicator").GetRect();
			Assert.That(Math.Abs(topLabelBeforeRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"Before keyboard - top label Y ({topLabelBeforeRect.Y}) should be ≈ insets.Top ({insets.Top}) (Default on FlexLayout = Container)");

			var bottomLabelBeforeRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			Assert.That(Math.Abs(bottomLabelBeforeRect.Bottom), Is.EqualTo(screenHeight - insets.Bottom).Within(PixelTolerance),
				$"Before keyboard - bottom label Bottom ({bottomLabelBeforeRect.Bottom}) should be ≈ screenHeight - insets.Bottom ({screenHeight - insets.Bottom}) (Default on FlexLayout = Container)");
...
#if IOS
			// Bottom should NOT move (Default = Container on FlexLayout — ignores keyboard)
			var bottomLabelDuringRect = App.WaitForElement("BottomEdgeIndicator").GetRect();
			...
			Assert.That(Math.Abs(topLabelDuringRect.Y), Is.EqualTo(insets.Top).Within(PixelTolerance),
				$"During keyboard - top label Y ({topLabelDuringRect.Y}) should remain at insets.Top ({insets.Top}) (Default on FlexLayout = Container)");
		...
		public void ValidatePerEdgeKeyboard_BottomNone_BottomStays_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomContainer_BottomStays_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomSoftInput_BottomMovesUp_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdgeKeyboard_BottomAll_BottomMovesUp_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidatePerEdge_LeftContainerRightNone_Landscape_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
		...
		public void ValidateOrientation_Roundtrip_PositionsRestore_FlexLayout()
		{
			ClickFlexLayoutSafeAreaButton();
			App.DismissKeyboard();
